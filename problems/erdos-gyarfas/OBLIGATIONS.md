...
| G006 | On the induced \(P_{13}\) forced by `C007`, classify how the cubic dominating set from `C005` can attach, and prove that a surviving attachment pattern yields a \(4\)-, \(8\)-, or \(16\)-cycle—or exhibit a pattern that refutes this route. | in_progress | A scalable route to `C001` | — |
