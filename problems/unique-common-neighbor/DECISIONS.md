...
| 2026-07-23 | Retire the internal-only rule: solution searches, citations, and reference comparison are freely permitted for this dossier, as everywhere. | The user clarified the repository mission: settle open conjectures by standing on all existing verified knowledge; there is no discipline of avoiding known solutions. The historical fact that this proof was developed without consultation is unchanged. | `O008`, `STATEMENT.md`, `STATE.md`, `OBLIGATIONS.md`, `PROOF.md`, `problem.json` |
