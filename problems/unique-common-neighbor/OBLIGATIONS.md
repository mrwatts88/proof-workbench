...
| G004 | Compare the internally developed and reviewed result with a reference solution only in a separately authorized later phase. | not_needed | Optional benchmark comparison, not the exact mathematical claim | No reference was inspected; `D003` records that comparison is outside completion of the internal result. |
